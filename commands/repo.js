...
const fetchGitHubRepoDetails = async () => {
  try {
    const _0x1c6838 = await axios.get("https://api.github.com/repos/Frontier-Lord200/DELTA-MD-V1");
    const {
      name: _0x4ae93b,
