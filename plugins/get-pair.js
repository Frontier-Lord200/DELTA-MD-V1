...
malvin({
    ...
    react: "✅",
    desc: "Get pairing code for DX bot",
    category: "download",
    ...
    try {
        ...
        const doneMessage = "> *DELTA-MD-V1 PAIRING COMPLETED*";
...
malvin({
    ...
    react: "✅",
    desc: "Get pairing code for DELTA-MD-V1 bot",
    category: "download",
    use: ".pair +2637582XXX",
    filename: __filename
}, async (conn, mek, m, { from, quoted, body, isCmd, command, args, q, isGroup, sender, senderNumber, botNumber2, botNumber, pushname, isMe, isOwner, groupMetadata, groupName, participants, groupAdmins, isBotAdmins, isAdmins, reply }) => {
    try {
        ...
        const pairingCode = response.data.code;
        const doneMessage = "> *DELTA-MD-V1 LINKING COMPLETED*";
