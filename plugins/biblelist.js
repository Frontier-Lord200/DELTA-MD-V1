...
`;
        ...
        // Image URL
        const imageUrl = "https://files.catbox.moe/2rvshj.jpg"; // Replace with the actual image URL
        ...
        await conn.sendMessage(m.chat, {
            image: { url: imageUrl },
            caption: `📖 *Bible List By Delta mᴅ*:\n\n` +
                     `Hey there Soldier Here is the complete list of books in the Bible:\n\n` +
