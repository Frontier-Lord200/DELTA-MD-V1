...
const port = process.env.PORT || 9090;
  ...
  let up = `*Hᴇʟʟᴏ ᴛʜᴇʀᴇ DELTA-MD-V1 Usᴇʀ! \ud83d\udc4b\ud83c\udffb* \n\n> sɪᴍᴘʟᴇ , sᴛʀᴀɪɢʜᴛ ғᴏᴡᴀʀᴅ ʙᴜᴛ ʟᴏᴀᴅᴇᴅ ᴡɪᴛʜ ғᴇᴀᴛᴜʀᴇs \ud83c\udf8a, ʙᴇsᴛ ᴡʜᴀᴛsᴀᴘᴘ ʙᴜᴅᴅʏ.\n\n *ᴛʜᴀɴᴋs ғᴏʀ ᴜsɪɴɢ DELTA-MD-V1 \ud83d\udea9* \n\n> Jᴏɪɴ ᴏᴜʀ ᴡʜᴀᴛsᴀᴘᴘ ᴄʜᴀɴɴᴇʟ :- ⤵️\n\nhttps://whatsapp.com/channel/0029Vb5Xj7xGzzKYC7hKle2bn\n- *ʏᴏᴜʀ ᴘʀᴇғɪx:* = [ ${prefix} ]\n\nᴅᴏɴᴛ ғᴏʀɢᴇᴛ ᴛᴏ ɢɪᴠᴇ ᴀ sᴛᴀʀ ᴛᴏ ᴏᴜʀ ʀᴇᴘᴏ ⬇️\n\nhttps://github.com/Frontier-Lord200/DELTA-MD-V1\n\n> © ᴘᴏᴡᴇʀᴇᴅ ʙʏ USMAN & Frontier \ud83d\udda4`;
    conn.sendMessage(conn.user.id, { image: { url: `https://files.catbox.moe/2rvshj.jpg` }, caption: up })
  }
  })
